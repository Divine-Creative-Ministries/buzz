...
export type Profile = {
  pubkey: string;
  displayName: string | null;
  verifiedName?: string | null; // Relay-authoritative display identity bound to this pubkey.
  verifiedNameExpiresAt?: number | null; // Unix seconds after which the name is untrusted.
