...
({
  AsyncValue<List<TimelineMessage>> replyMessages,
  List<NostrEvent> liveChannelEvents,
})
useThreadLiveReplies({
  ...
  return (replyMessages: replyMessages, liveChannelEvents: liveChannelEvents);
}
